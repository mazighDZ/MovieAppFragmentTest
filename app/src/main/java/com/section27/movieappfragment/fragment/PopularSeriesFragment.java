...
import com.section27.movieappfragment.databinding.FragmentPopularSeriesBinding;
 ...
 * Use the {@link PopularSeriesFragment#newInstance} factory method to
...
public class PopularSeriesFragment extends Fragment {
    ...
    private FragmentPopularSeriesBinding fragmentPopularSeriesBinding;
     ...
     * @return A new instance of fragment PopularSeriesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PopularSeriesFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentPopularSeriesBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_popular_series , container ,false)  ;
        View view = fragmentPopularSeriesBinding.getRoot();

        //set viewModel
        movieViewModel = new ViewModelProvider(this).get(MovieViewModel.class);
        // set recycler view
        recyclerView = fragmentPopularSeriesBinding.rvMovies;
    ...
    private void getPopularMovies(int pageTemp) {
        ...
        movieViewModel.getMutableLiveData(MovieRepository.POPULAR_SERIES , pageTemp).observe(getActivity(), new Observer<List<Movie>>() {
            @Override
